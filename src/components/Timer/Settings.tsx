...
export const TimerSettings = ({ onClose }) => {
  ...
  function onSubmit() {
    ...
    onClose();
    successToast("Ayarlar Kaydedildi", isDark);
  }
  ...
  return (
    <div className="w-72 max-w-sm rounded-lg bg-white p-2 px-1 text-gray-800 shadow-md dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 sm:w-96">
      ...
      <div className="grid">
        <div className="text-center text-lg">Ayarlar</div>
        <div className="border-gray-100 p-4">
          <div className="rounded p-2 text-center">
            Süreler <span className="italic">(Dakika)</span> olarak ayarlanır
          </div>
        ...
        <div className="border-gray-100 p-4">
          <div className="rounded p-2 text-center">Alarm Ses Seviyesi</div>
        ...
        <hr className="border-t-3 border-[#5c5c5c]" />
        <div className="border-gray-100 p-4">
          <div className="rounded p-2 text-center">Alarm Sesleri</div>
